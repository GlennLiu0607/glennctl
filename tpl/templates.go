...
import (
	...
	apinew "github.com/GlennLiu0607/glennctl/api/new"
	"github.com/GlennLiu0607/glennctl/docker"
	"github.com/GlennLiu0607/glennctl/gateway"
	"github.com/GlennLiu0607/glennctl/kube"
	mongogen "github.com/GlennLiu0607/glennctl/model/mongo/generate"
	modelgen "github.com/GlennLiu0607/glennctl/model/sql/gen"
	tdgen "github.com/GlennLiu0607/glennctl/model/tdengine/generate"
	rpcgen "github.com/GlennLiu0607/glennctl/rpc/generator"
...
func revertTemplates(_ *cobra.Command, _ []string) (err error) {
	...
	case tdgen.Category():
		return tdgen.RevertTemplate(filename)
	case mongogen.Category():
